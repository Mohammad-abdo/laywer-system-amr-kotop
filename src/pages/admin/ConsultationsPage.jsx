...
const ConsultationsPage = () => {
  ...
  const canEdit = true; // Consultations can be edited by all authenticated users
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Link to="/admin/consultations/new" className="btn btn-primary">
          + New Consultation
        </Link>
      </div>
      ...
      <div className="card">
        {consultations.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg mb-4">No consultations found</p>
            <Link to="/admin/consultations/new" className="btn btn-primary">
                    ...
                    <tr key={consultation.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex items-center gap-3">
                          ...
                          {canEdit && (
                            <Link
                              to={`/admin/consultations/${consultation.id}/edit`}
